...
public final class FastExcel implements Closeable {
    ...
    public void setSheetName(String sheetName) {
        ...
        // if (null == sheet) {
        // throw new RuntimeException("sheetName:" + sheetName + " is not
        // exist");
        // }
            ...
            case Cell.CELL_TYPE_NUMERIC:
                if (DateUtil.isCellDateFormatted(cell)) {
                    ...
                    if (field.getType().isAssignableFrom(Integer.class) || field.getType().getName().equals("int")) {
                        ...
                        String s = String.valueOf(cell.toString());
					...
					if (s.contains("E")) {
                        ...
                        field.set(o, BigDecimal.valueOf(cell.getNumericCellValue()));
                    }
                }
                break;
        ...
        if (null != list && !list.isEmpty()) {
            ...
            for (Field field : fields) {
                if (field.isAnnotationPresent(MapperCell.class)) {
                    ...
                    widthMap.put(mapperCell.order(), mapperCell.width());
                }
            }
            try {
     ...
     * @throws IOException
     */
    public static <T> boolean exportExcel(HttpServletResponse response, String fileName, List<T> list)
            throws IOException {
     ...
     * @throws IOException
     */
    public static <T> boolean exportExcel(HttpServletResponse response, String fileName, Map<Integer, String> titleMap,
    ...
    public static <T> boolean dlImportModel(HttpServletResponse response, String fileName, Class<T> clazz)
            throws IOException {
        HSSFWorkbook workbook = new HSSFWorkbook();
        boolean result = false;
        OutputStream fileOutputStream = null;
