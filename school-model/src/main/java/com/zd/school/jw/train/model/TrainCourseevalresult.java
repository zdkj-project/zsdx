...
/**
 * 
 * ClassName: TrainCourseevalresult 
 * Function: TODO ADD FUNCTION. 
 * Reason: TODO ADD REASON(可选). 
 * Description: 课程评价结果(TRAIN_T_COURSEEVALRESULT)实体类.
 * date: 2017-06-19
 *
 * @author  luoyibo 创建文件
 * @version 0.1
...
@Entity
@Table(name = "TRAIN_T_COURSEEVALRESULT")
@AttributeOverride(name = "uuid", column = @Column(name = "COURSEEVALRESULT_ID", length = 36, nullable = false))
public class TrainCourseevalresult extends BaseEntity implements Serializable{
