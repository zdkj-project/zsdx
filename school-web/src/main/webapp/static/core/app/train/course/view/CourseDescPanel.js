    ...
    /*
        tpl:new Ext.XTemplate(
        '<div style="border:1;width:1000px">',
        '<ul class="trainClass_gridUl" style="font-family:microsoft yahei;list-style:none">',
             '<li class="coursename" style="width:1000px;font-size:13px">2017年中山市第一期公务员初任培训班教学评估表{SSSD、}',
             '</li>',
               '<li><span style="width:10%">课程名称</span><span style="width:90%">{SSDDD、}</span>/li>',
               '<li><span style="width:10%">课程类型</span style="width:90%"><span>{ZZ}%</span></li>',
               '<li><span style="width:10%">授课教师</span style="width:90%"><span>刘明{}</span></li>',
               '<li><span style="width:10%；background: grey">评估指标</span><span style="width:30%">评估标准</span>',
               '<span style="width:10%">很满意</span><span style="width:10%">满意</span><span style="width:10%">基本满意</span>',
               '<span style="width:10%">不满意</span><span style="width:10%">很满意度</span><span style="width:10%">满意度</span></li>',
               '<li><span style="width:10%">教学内容</span>',
               '<span width="30%">紧密联系实际，针对性、实用性、系统性强;内容丰富，前瞻性、新颖性、时效性强。</span>',
               '<span>64</span><span>12</span><span>0</span><span>0</span><span>84.2%</span><span>100%</span>',
             '</li>',
           '</ul>',
        '</div>'
