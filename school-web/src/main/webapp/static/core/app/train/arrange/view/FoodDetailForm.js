Ext.define("core.train.arrange.view.FoodDetailForm", {
    extend: "core.base.view.BaseForm",
    alias: "widget.arrange.fooddetailform",
    layout: "form", //从上往下布局
    autoHeight: true,
    frame: false,
    ...
    items: [{
        ...
        items: [{
            ...
            listeners: {
                change: function(combo, record, index) {
                    ...
                    var currentForm=combo.up("baseform[xtype=arrange.fooddetailform]");
        ...
        items: [{
            ...
            listeners: {
                change: function(field, record, index) {                  
                    var currentForm=field.up("baseform[xtype=arrange.fooddetailform]");
        ...
        items: [{
            ...
            height: 300,
            store:{
                type:"arrange.trainfoodgridStore"
            },
            ...
            columns: [
                ...
                { text: '早餐', dataIndex: 'breakfast', flex: 1,
                    renderer : function(v, p, record){     
                        if(v==true)             
                ...
                {   text: '午餐', dataIndex: 'lunch', flex: 1,
                    renderer : function(v, p, record){     
                        if(v==true)             
                            return '<span class="x-grid-checkcolumn x-grid-checkcolumn-checked" role="button" tabindex="-1"  data-tabindex-value="0" data-tabindex-counter="1"></span>';
                        else
                ...
                {  text: '晚餐', dataIndex: 'dinner', flex: 1,
                    renderer : function(v, p, record){     
                        if(v==true)             
                            return '<span class="x-grid-checkcolumn x-grid-checkcolumn-checked" role="button" tabindex="-1"  data-tabindex-value="0" data-tabindex-counter="1"></span>';
                        else
