        ...
        tpl: new Ext.XTemplate(
            '<div class="trainTeacher_teacherInfo">',
                ...
                '<div class="trainTeacher_right">',
                    '<ul>',
                        '<li  style="font-size:16px;">电话：{mobilePhone}</li>',
                        '<li title={sfzjh} style="font-size:16px;">身份证号码：{sfzjh}</li>',
                        '<li style="font-size:16px;">电子邮件：{dzxx}</li>',
                        '<li style="font-size:16px;">校内/校外：{inout}</li>',
                        '<li style="font-size:16px;">行政级别：{headshipLevel}</li>',
                        '<li title={workUnits} style="font-size:16px;">工作单位：{workUnits}</li>',
