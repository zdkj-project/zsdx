 ...
 */
Ext.define("core.train.trainee.controller.OtherController", {
    extend: "Ext.app.ViewController",
    alias: 'controller.trainee.otherController',
    mixins: {
    ...
    control: {
         ...
         * 导入的保存按钮
         */
        "panel[xtype=trainee.traineeimportform] button[ref=formSave]": {
            beforeclick: function (btn) {
                var self = this;
                var dicForm = btn.up('panel[xtype=trainee.traineeimportform]');
         ...
         * 导入的关闭按钮
         */
        "panel[xtype=trainee.traineeimportform] button[ref=formClose]": {
            click: function (btn) {
                var win = btn.up('window');
                //关闭窗体
                win.close();
