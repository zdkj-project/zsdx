	...
	items: [{        
        ...
        tpl: new Ext.XTemplate(
            '<div class="trainClass_classTraineeInfo">',
                ...
                '<ul class="trainClass_gridUl">',
                    '<li><span style="width:5%">序号</span><span style="width:20%">姓名</span><span style="width:5%">性别</span><span style="width:20%">是否午休</span><span style="width:20%">是否晚宿</span><span style="width:20%">宿舍名称</span><span style="width:10%">学员状态</span></li>',
                '{% if (values.length == 0) %}', 
