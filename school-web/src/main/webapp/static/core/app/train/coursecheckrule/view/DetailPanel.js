     ...
     */
    Ext.define('core.train.coursecheckrule.view.DetailPanel', {
        extend: 'Ext.Container',
        alias: "widget.coursecheckrule.DetailPanel",
        layout: "form", //从上往下布局
        autoHeight: true,
        frame: false,
        style: {
        ...
        tpl: new Ext.XTemplate(
            '<div class="trainClass_classInfo">',
                '<div class="trainClass_title">规则详细：</div>',
                '<ul>',
                    '<li style="width:30%">规则名称：{ruleName}</li>',
                    '<li style="width:30%">考勤模式：{checkMode}</li>',
