    ...
    items: [{
        ...
        items: [{
            ...
            columns: [
                ...
                { align: 'center', titleAlign: "center", text: '是否住宿', dataIndex: 'ifaccommodation', flex: 1.5},
                {align: 'center', titleAlign: "center", text: '入住日期', dataIndex: 'checkinDate', flex: 1.5},
                {align: 'center', titleAlign: "center", text: '退宿日期', dataIndex: 'checkoutDate', flex: 1.5},
                {
