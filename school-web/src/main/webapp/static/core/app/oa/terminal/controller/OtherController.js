...
*/
Ext.define("core.oa.terminal.controller.OtherController", {
    extend: "Ext.app.ViewController",
    alias: 'controller.terminal.otherController',
    mixins: {
    ...
    /** 该视图内的组件事件注册 */
    control: {
        "baseformtab[detCode=terminal_detail] button[ref=formSave]":{
        ...
        "baseformwin[funCode=terminal_detail] button[ref=formContinue]": {
            beforeclick: function(btn) {
        ...
        "baseformwin[funCode=terminal_detail] button[ref=formSave]": {
            beforeclick: function(btn) {
