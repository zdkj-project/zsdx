...
<div class="weui-cell__bd" style="position: absolute;top: 10;right: -80;" id="order">

    <img src="/static/core/app/miniweb/img/reservation/2.png" style=" margin-bottom: -2%;" width="7%"> 订餐
</div>
<div class="weui-cell__bd" style="position: absolute;top: 10;right: -140;" id="notOrder">
    <img src="/static/core/app/miniweb/img/reservation/3.png" style=" margin-bottom: -2%;" width="7%"> 取消
</div>
<form id="addForm">
    <div id="list"></div>
</form>
