Ext.define("core.cashier.mealset.controller.MainController", {
    extend: "Ext.app.ViewController",
    alias: 'controller.mealset.mainController',
    mixins: {
    ...
    control: {
    	"basegrid[xtype=mealset.maingrid]": {
    ...
    doMainDetail_Tab: function (btn, cmd, grid, record) {
        ...
        var itemXtype = "mealset.detailform";
            ...
            setTimeout(function () {
                ...
                switch (cmd) {
                    case "edit":
                        ...
                        var standgrid = tabItem.down("grid[xtype=mealset.standgrid]");
