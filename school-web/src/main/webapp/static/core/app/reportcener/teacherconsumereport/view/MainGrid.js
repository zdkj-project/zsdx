Ext.define("core.reportcenter.teacherconsumereport.view.MainGrid", {
    extend: "core.base.view.BaseGrid",
    alias: "widget.teacherconsumereport.maingrid",
    al:false,
    frame: false,
    columnLines: false,
    dataUrl: comm.get("baseUrl") + "/TrainReport/getTeacherConsumeTotalList", //数据获取地址
    model: "com.zd.school.cashier.model.CashExpenseserial", //对应的数据模型
    /**
     * 高级查询面板
     */
    panelButtomBar: {
        xtype: 'teacherconsumereport.mainquerypanel',
    },
    selModel: null,
