...
*/
Ext.define("core.ordermanage.orderdiffreport.controller.OtherController", {
    extend: "Ext.app.ViewController",
    alias: 'controller.orderdiffreport.otherController',
    mixins: {
    ...
    control: {
        'baseformwin button[ref=formSave]':{
            beforeclick:function(btn){
                ...
                var objForm = win.down("baseform[xtype=cashreport.remarkform]");
                ...
                if (formObj.isValid()) {
                    ...
                    Ext.Msg.confirm('温馨提示', "您确定要保存备注信息吗？", function (btn2, text) {
                        if (btn2 == "yes") {
                            ...
                            self.asyncAjax({
                                url: comm.get("baseUrl") + "/CashExpenseserial/doSetRemark",
                                params: params,
                                //回调代码必须写在里面
