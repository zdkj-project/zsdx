...
/**
 * 
 * ClassName: OaMeetingcheckruleController
 * Function:  ADD FUNCTION. 
 * Reason:  ADD REASON(可选). 
 * Description: 会议考勤规则(OA_T_MEETINGCHECKRULE)实体Controller.
 * date: 2017-03-07
 *
 * @author  luoyibo 创建文件
 * @version 0.1
 ...
 */
@Controller
@RequestMapping("/OaMeetingcheckrule")
public class OaMeetingcheckruleController extends FrameWorkController<OaMeetingcheckrule> implements Constant {

    @Resource
    OaMeetingcheckruleService thisService; // service层接口
    ...
    public void list(@ModelAttribute OaMeetingcheckrule entity, HttpServletRequest request, HttpServletResponse response)
            throws IOException {
...
//        strData = jsonBuilder.buildObjListToJson(qResult.getTotalCount(), qResult.getResultList(), true);// 处理数据
    ...
    public void doAdd(OaMeetingcheckrule entity, HttpServletRequest request, HttpServletResponse response)
    ...
    */
    ...
    public void doUpdates(OaMeetingcheckrule entity, HttpServletRequest request, HttpServletResponse response)
            throws IOException, IllegalAccessException, InvocationTargetException {
