 ...
 * Description: 用户数据权限表(SYS_T_DATAPERMISSION)实体Controller.
 * date: 2016-09-01
 *
 * @author  luoyibo 创建文件
 * @version 0.1
...
public class SysDatapermissionController extends FrameWorkController<SysDatapermission> implements Constant {

    @Resource
    SysDatapermissionService thisService; // service层接口
    ...
    public void list(@ModelAttribute SysDatapermission entity, HttpServletRequest request, HttpServletResponse response)
        ...
        QueryResult<SysDatapermission> qr = thisService.getPaginationQuery(super.start(request), super.limit(request),
    ...
    public void doAdd(SysDatapermission entity, HttpServletRequest request, HttpServletResponse response)
	...
	SysDatapermission perEntity = new SysDatapermission();
    ...
    */
    ...
    public void doUpdates(SysDatapermission entity, HttpServletRequest request, HttpServletResponse response)
            throws IOException, IllegalAccessException, InvocationTargetException {
        ...
        SysDatapermission perEntity = thisService.get(entity.getUuid());
