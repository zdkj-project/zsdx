 ...
 */
@Controller
@RequestMapping("/SkPriceDefine")
public class SkPriceDefineController extends  FrameWorkController<SkPriceDefine> implements Constant  {
	@Resource
	SkPriceDefineService thisService; // service层接口
	...
	public void list(@ModelAttribute SkPriceDefine entity, HttpServletRequest request, HttpServletResponse response)
			throws IOException {
		  String strData = ""; // 返回给js的数据
	        QueryResult<SkPriceDefine> qr = thisService.getPaginationQuery(super.start(request), super.limit(request),
	...
	public void doAdd(
			SkPriceDefine entity, HttpServletRequest request, HttpServletResponse response)
	...
	public void doUpdates(SkPriceDefine entity, HttpServletRequest request, HttpServletResponse response)
			throws IOException, IllegalAccessException, InvocationTargetException {
		...
		SkPriceDefine perEntity = thisService.get(entity.getUuid());
