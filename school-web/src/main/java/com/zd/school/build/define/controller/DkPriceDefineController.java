 ...
 */
@Controller
@RequestMapping("/DkPriceDefine")
public class DkPriceDefineController extends  FrameWorkController<DkPriceDefine> implements Constant  {
	@Resource
	DkPriceDefineService thisService; // service层接口
	...
	public void doAdd(DkPriceDefine entity, HttpServletRequest request, HttpServletResponse response)
	...
	public void doUpdates(DkPriceDefine entity, HttpServletRequest request, HttpServletResponse response)
			throws IOException, IllegalAccessException, InvocationTargetException {
		...
		DkPriceDefine perEntity = thisService.get(entity.getUuid());
