...
public interface OpuService {
	 ...
	 *            入账金额
	 * @param checkcode
	 *            校验码，由 房间号+证件号+入账金额得到的字符串,经过MD5加密变成的32位小写MD5字符串
	 * @param type
	 *            入账类型，0银行卡信用卡，1微信，2支付宝，3退款
	 * @return 见实体类说明
	 */
	 ...
	 *            房间号
	 * @param checkinDate
	 *            入住日期，格式yyyy-MM-dd 例：2017-12-05
	 * @param checkoutDate
	 *            离店日期，格式yyyy-MM-dd 例：2017-12-08
	 * @param price
	 *            房租
	 * @return 见实体类说明
	 */
	 ...
	 *            联系人电话
	 * @param personsJson
	 *            人员名单json字符串，isCheckin0表示住宿，1表示不住宿,格式如下： [
