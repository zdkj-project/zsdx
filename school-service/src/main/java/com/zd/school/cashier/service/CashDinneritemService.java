...
/**
 * 
 * ClassName: CashDinneritemService
 * Function: TODO ADD FUNCTION. 
 * Reason: TODO ADD REASON(可选). 
 * Description: 快餐项定义(CASH_T_DINNERITEM)实体Service接口类.
 * date: 2017-09-13
 *
 * @author  luoyibo 创建文件
 * @version 0.1
...
public interface CashDinneritemService extends BaseService<CashDinneritem> {
