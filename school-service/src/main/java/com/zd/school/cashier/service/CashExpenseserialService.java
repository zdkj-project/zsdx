...
/**
 * 
 * ClassName: CashExpenseserialService
 * Function: TODO ADD FUNCTION. 
 * Reason: TODO ADD REASON(可选). 
 * Description: 消费流水(CASH_T_EXPENSESERIAL)实体Service接口类.
 * date: 2017-09-25
 *
 * @author  luoyibo 创建文件
 * @version 0.1
...
public interface CashExpenseserialService extends BaseService<CashExpenseserial> {
