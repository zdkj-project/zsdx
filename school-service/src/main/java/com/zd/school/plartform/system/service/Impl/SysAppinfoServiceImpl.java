...
/**
 * 
 * ClassName: SysAppinfoServiceImpl
 * Function:  ADD FUNCTION. 
 * Reason:  ADD REASON(可选). 
 * Description: (SYS_T_APPINFO)实体Service接口实现类.
 * date: 2017-05-15
 *
 * @author  luoyibo 创建文件
 * @version 0.1
...
public class SysAppinfoServiceImpl extends BaseServiceImpl<SysAppinfo> implements SysAppinfoService{
	...
	public QueryResult<SysAppinfo> list(Integer start, Integer limit, String sort, String filter, Boolean isDelete) {
        QueryResult<SysAppinfo> qResult = this.getPaginationQuery(start, limit, sort, filter, isDelete);
		return qResult;
	}
	/**
	 * 根据主键逻辑删除数据
