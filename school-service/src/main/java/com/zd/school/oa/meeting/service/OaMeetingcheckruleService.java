...
/**
 * 
 * ClassName: OaMeetingcheckruleService
 * Function: TODO ADD FUNCTION. 
 * Reason: TODO ADD REASON(可选). 
 * Description: 会议考勤规则(OA_T_MEETINGCHECKRULE)实体Service接口类.
 * date: 2017-03-07
 *
 * @author  luoyibo 创建文件
 * @version 0.1
...
public interface OaMeetingcheckruleService extends BaseService<OaMeetingcheckrule> {
